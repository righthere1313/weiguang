function orderStudentGrade(students) {
    ...
    //     const sum=students[i].classPerformance+students[i].defense+students[i].finalExam;
    //     const sum1=students[j].classPerformance+students[j].defense+students[j].finalExam;
    //       if(sum<sum1){
    ...
    const students=result[cls];
    students.sort((a,b)=>{
        const sum1=a.classPerformance+a.defense+a.finalExam;
        const sum2=b.classPerformance+b.defense+b.finalExam;
        return sum2-sum1;
      });
    }
    return result;
...
Object.keys(result).forEach((cls) => {
    ...
    students.forEach((student) => {
        ...
        td2.innerText = student.defense;//答辩表现
        tr.appendChild(td2);

        const td3 = document.createElement("td");
        td3.innerText = student.classPerformance;//课堂表现
        tr.appendChild(td3);

        const td4 = document.createElement("td");
        td4.innerText = student.finalExam;//期末成绩
        tr.appendChild(td4);
